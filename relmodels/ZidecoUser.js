...
module.exports = function(models) {
    ...
    ZidecoUser.getUnPersistableInstance = function(data) {
        var zidecoUser = new ZidecoUser();
        zidecoUser.id = data.id;
        zidecoUser.identifier = data.identifier;
        zidecoUser.disabled = data.disabled;
        zidecoUser.logintype = data.logintype;
        zidecoUser.passhash = data.passhash;
        zidecoUser.experationDate = data.experationDate;

        zidecoUser.roles = data.roles;
        zidecoUser.aliases = data.aliases;
        zidecoUser.timeentires = data.timeentires;
        zidecoUser.timeperiods = data.timeperiods;
